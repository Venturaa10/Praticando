...
palavra = input('Digite a palavra: ').capitalize().strip()
...
'''
pesquisa_dic = input('Buscar palavra: ').capitalize().strip()

if pesquisa_dic in dicionario:
    print('Essa palavra já existe no dicionario!')
    print(f'Chave: {pesquisa_dic}: {dicionario[pesquisa_dic]}')

else:
    print(f'{pesquisa_dic} não existe no dicionario')
'''
